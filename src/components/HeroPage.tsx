...
export default function HeroPage() {
    return (
        <div className="bg-[url('/images/bg.jpg')]  mt-10 bg-cover bg-center bg-no-repeat h-[300px] sm:h-[400px] md:h-[500px] lg:[800px] ">
            ...
            <Link  href={'/blogPage'} className={`${Font2.className} font-bold text-3xl sm:text-4xl md:text-6xl text-white hover:text-blue-950 hover:border-blue-950 p-3 rounded-full hover:ring-1 shadow-md hover:shadow-lg`}>
                Blog posts
            </Link>
            </div>
        </div>
