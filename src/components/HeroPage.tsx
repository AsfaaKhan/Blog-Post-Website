...
export default function HeroPage() {
    return (
        <div className="bg-[url('/images/bg.jpg')] bg-cover bg-center bg-no-repeat h-[300px] sm:h-[400px] md:h-[500px] ">
            <div className="flex flex-col gap-8 justify-center items-center pt-[100px]">
            <h1 className={`${Font.className}  text-5xl sm:text-6xl md:text-8xl font-extrabold  text-blue-950 `}>
                CLICK - WORTHY
            </h1>
